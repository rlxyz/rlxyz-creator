...
const {
  buildWhitelist,
  generateLeaf,
} = require("../scripts/helpers/whitelist");
...
describe("RhapsodyCreator", () => {
  ...
  beforeEach(async () => {
    [deployer, admin, minterA, minterB, minterC] =
  ...
  describe("sale", () => {
    ...
    describe("publicMint", () => {
      ...
      it("should be able to mint nfts in public mint", async () => {
        await expect(publicMinter(minterA, 1, 0.08))
