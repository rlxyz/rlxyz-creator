    ...
    types.forEach((type) => {
      switch (type) {
        case 'claim':
          ...
          else if (variation === 'generative') _testContractClaimGenerative(_beforeEach);
          break;
        case 'presale':
...
const _testContractClaimGenerative = (_beforeEach: RhapsodyCreatorBeforeEach) => {
  describe('claimMint', () => {
...
const _testContractClaimBasic = (_beforeEach: RhapsodyCreatorBeforeEach) => {
  describe('claimMint', () => {
    let minterA: any, minterB: any, minterC: any;
